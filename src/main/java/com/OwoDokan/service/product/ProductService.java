package com.OwoDokan.service.product;

import com.OwoDokan.exceptions.BrandsNotFoundException;
import com.OwoDokan.exceptions.CategoryNotFoundException;
import com.OwoDokan.exceptions.ProductNotFoundException;
import com.OwoDokan.entity.product.OwoProduct;
import com.OwoDokan.repository.product.ProductRepository;
...
public class ProductService {
    ...
    public List<OwoProduct> sortAlphabetically( int page, List<String> subCategories, String alphabet )
    {
        int pageSize = 10; //products per page
        org.springframework.data.domain.Pageable pageable = PageRequest.of(page, pageSize);

        Optional<List<OwoProduct>> optionalOwoProductList = productRepository.sortProductAlphabetically(pageable, subCategories, alphabet + "%");
        ...
        {
            log.error("Product does not exists for sorting with "+alphabet);
